...
enum {
	...
	POWER_SUPPLY_CAPACITY_LEVEL_MIDDLE,
...
enum power_supply_charger_cable_type {
	...
	POWER_SUPPLY_CHARGER_TYPE_OTG = 1 << 12,
	POWER_SUPPLY_CHARGER_TYPE_OTG_OUT = 1 << 13,
    POWER_SUPPLY_CHARGER_TYPE_USB_TYPEC = 1 << 14,
};
